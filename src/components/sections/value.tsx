      ...
      <m.div style={{ opacity }} className="mb-40 relative">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="flex-1 space-y-20">
            <h2 className="font-heading text-5xl md:text-9xl lg:text-[150px] font-black leading-[0.75] tracking-[-0.06em] text-foreground uppercase select-none">
              <m.div
